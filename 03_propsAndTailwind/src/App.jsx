...
function App({myname:[zahid,...myname]}) {
  const [count, setCount] = useState(0);
  console.log(zahid,myname);
  return (
    <>
      <h1
        className=" bg-green-600 font-bold  font-serif text-7xl flex justify-center 
        ...
        <div className="grid grid-cols-1 gap-[30px] md:grid-cols-3">
          <div className="flex flex-col items-center text-start">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4">
                <h1 className="text-xl font-semibold text-white">{zahid}</h1>
          ...
          <div className="flex flex-col items-center text-start">
            ...
            >
              ...
              />
              <div className="absolute bottom-4 left-4">
                <h1 className="text-xl font-semibold text-white">{myname[0]}</h1>
